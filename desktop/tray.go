...
func (a *App) startTray() bool {
	...
	a.mu.Unlock()
		...
		systray.SetTitle(northwingProductName)
		systray.SetTooltip(northwingProductName)
...
func trayMenuLabels(locale string) trayLabels {
	if locale == "zh" {
		return trayLabels{
			openTitle:   "打开",
			openTooltip: "打开 Northwing 窗口",
			quitTitle:   "退出",
			quitTooltip: "退出 Northwing",
		}
	}
	return trayLabels{
		openTitle:   "Open",
		openTooltip: "Open the Northwing window",
		quitTitle:   "Quit",
		quitTooltip: "Quit Northwing",
	}
}
