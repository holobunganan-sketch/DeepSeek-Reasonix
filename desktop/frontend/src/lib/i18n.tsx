...
const PRODUCT_BRAND_KEYS: ReadonlySet<DictKey> = new Set([
  ...
  "caps.jsonUnsupported",
  "approval.allowConfigWriteSessionDesc",
  "approval.allowConfigWriteSession",
  "approval.planModeBashTrustReason",
  "approval.toolLabelConfigWrite",
  "approval.configWriteSubjectPrefix",
  "approval.configWriteReason",
  "updater.installing",
  "settings.effortProtocolDefault.none",
