...
ok(/holobunganan-sketch\/Northwing\/releases/.test(updater), "runtime checks only the independent Northwing repository");
...
ok(/ApplyNorthwingUpdateRequest/.test(hook), "frontend never hands a Northwing release to the inherited updater");
